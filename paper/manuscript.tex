%%%%% options, to be defined externally
...
\ifx\hidefigures\undefined
  \newcommand{\captionbaseline}{1} % EH: compress captions if we have figures
\else
  \newcommand{\captionbaseline}{2}
\fi

\makeatletter
\long\def\@makecaption#1#2{%
  \renewcommand{\baselinestretch}{\captionbaseline}
...
\newblock {\em Progress of Theoretical Physics}, 52(6):1744--1765.
...
\newblock {\em European Journal of Neuroscience}, 25(11):3429--41.
